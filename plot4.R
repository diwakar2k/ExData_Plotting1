...
globalReactivePower <- as.numeric(used_data$Global_reactive_power)
voltage <- as.numeric(used_data$Voltage)
subMetering1 <- as.numeric(used_data$Sub_metering_1)
subMetering2 <- as.numeric(used_data$Sub_metering_2)
subMetering3 <- as.numeric(used_data$Sub_metering_3)
